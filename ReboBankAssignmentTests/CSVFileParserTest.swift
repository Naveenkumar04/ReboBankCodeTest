...
class CSVFileParserTest: XCTestCase {
    ...
    func testThatItParsesLinesSeperatedByNewLines() {
        ...
        let arrayUnderTest =  CSVFileParser(with: testString).rows
    ...
    func testThatItParsesHeadersCorrectly() {
        ...
        let arrayUnderTest : [String] =  CSVFileParser(with: testString).headers
    ...
    func testThatItParsesRowsWithoutHeaders() {
        ...
        let arrayUnderTest = CSVFileParser(with: testString, separator:",", headers:["Year","Make","Model","Description","Price"]).rows
    ...
    func testThatItParsesRowsLongerThanHeaders() {
        ...
        let csv = CSVFileParser(with: testString)
    ...
    func testThatCanReturnKeyedRows() {
        ...
        let arrayUnderTest =  CSVFileParser(with: testString).keyedRows!
    ...
    func testThatItCanParseArbitrarySeparators() {
        ...
        let arrayUnderTest =  CSVFileParser(with: testString, separator:"\t").keyedRows!
    ...
    func testThatItCanGetCellsFromAstring() {
        ...
        let arrayUnderTest = CSVFileParser.records(from: testString)
    ...
    func testThatItCanGetCells() {
        ...
        let arrayUnderTest = CSVFileParser.cells(forRow: testString)
    ...
    func testPerformance() {
        ...
        measure {
            let _ = CSVFileParser(with: testString)
        }
    }
